...
def divergence(field_x, field_y, field_z, dx, npatch):
    '''
...
def curl(field_x, field_y, field_z, dx, npatch):
    '''
...
def curl_magnitude(field_x, field_y, field_z, dx, npatch):
    '''
...
def gradient_magnitude(field, dx, npatch):
    '''
