...
def read_grids(it, path='', paraname='masclet_parameters.json', parameters_path='', digits=5, read_general=True, read_patchnum=True, read_dmpartnum=True,
    ...
    Args:
        ...
        paraname: name of the MASCLET parameters file (str)
    ...
    """
    nmax, nmay, nmaz, size = parameters.read_parameters(filename=paraname, load_nma=True, load_npalev=False, load_nlevels=False,
